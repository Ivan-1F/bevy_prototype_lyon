...
fn redraw_line_width(mut query: Query<&mut Shape, With<HexagonShape>>, time: Res<Time>) -> Result {
...
fn redraw_fill(mut query: Query<&mut Shape, With<TriangleShape>>, time: Res<Time>) -> Result {
